...
public:
    ...
    MsgPtr createMsg(MsgIdParamType id, unsigned idx = 0U, CreateFailureReason* reason = nullptr) const
    {
        ...
        switch (id) {
            case cc_demo2::MsgId_Msg1: return MsgPtr(new cc_demo2::message::Msg1<TInterface, TProtOptions>);
            case cc_demo2::MsgId_Msg2: return MsgPtr(new cc_demo2::message::Msg2<TInterface, TProtOptions>);
            default: break;
        }
