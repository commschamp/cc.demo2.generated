...
#include "cc_demo2/input/AllMessages.h"
...
///     like @ref cc_demo2::options::DefaultOptions.
...
///     @code
///     using MyInterface = cc_demo2::Message<...>;
///     using MyMsg1 = cc_demo2::message::Msg1<MyInterface, cc_demo2::options::DefaultOptions>;
///     using MyMsg2 = cc_demo2::message::Msg2<MyInterface, cc_demo2::options::DefaultOptions>;
///     struct MyHandler {
...
/// @note Defined in cc_demo2/dispatch/DispatchMessage.h
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    ...
    switch(id) {
    case cc_demo2::MsgId_Msg1:
    {
        using MsgType = cc_demo2::message::Msg1<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    case cc_demo2::MsgId_Msg2:
    {
        using MsgType = cc_demo2::message::Msg2<InterfaceType, TProtOptions>;
        return handler.handle(static_cast<MsgType&>(msg));
    }
    default:
        break;
...
///     cc_demo2::options::DefaultOptions as first template parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchMessage()
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<cc_demo2::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchMessage<cc_demo2::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_demo2::options::DefaultOptions.
/// @headerfile cc_demo2/dispatch/DispatchMessage.h
template <typename TProtOptions = cc_demo2::options::DefaultOptions>
struct MsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(cc_demo2::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_demo2::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_demo2::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(cc_demo2::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_demo2::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return cc_demo2::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref cc_demo2::options::DefaultOptions as template parameter.
/// @note Defined in cc_demo2/dispatch/DispatchMessage.h
