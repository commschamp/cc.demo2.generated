...
/// @note Defined in cc_demo2/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_demo2::options::DefaultOptions>(id, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_demo2::options::DefaultOptions>(id, idx, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_demo2::options::DefaultOptions.
/// @headerfile cc_demo2/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(cc_demo2::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_demo2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_demo2::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_demo2::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_demo2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_demo2::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
