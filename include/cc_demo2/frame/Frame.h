...
#include "cc_demo2/frame/FrameCommon.h"
...
/// @see @ref Frame
/// @headerfile cc_demo2/frame/Frame.h
...
struct FrameLayers
{
    ...
    struct DataMembers
    {
        /// @brief Custom field for @ref cc_demo2::frame::FrameLayers::Data layer
        class Field : public
    ...
    struct VersionMembers
    {
        ...
        public:
            ...
            {
                return cc_demo2::frame::FrameLayersCommon::VersionMembersCommon::VersionCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return cc_demo2::frame::FrameLayersCommon::VersionMembersCommon::VersionCommon::name();
            }
        };
    };
    ...
    struct SizeMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return cc_demo2::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return cc_demo2::frame::FrameLayersCommon::SizeMembersCommon::SizeCommon::name();
            }
        };
    };
    ...
    struct ChecksumMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return cc_demo2::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return cc_demo2::frame::FrameLayersCommon::ChecksumMembersCommon::ChecksumCommon::name();
            }
        };
    };
    ...
    struct SyncMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return cc_demo2::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return cc_demo2::frame::FrameLayersCommon::SyncMembersCommon::SyncCommon::name();
            }
...
template <
   typename TMessage,
   typename TAllMessages = cc_demo2::input::AllMessages<TMessage>,
   typename TOpt = cc_demo2::options::DefaultOptions
>
class Frame : public
