...
#include "cc_demo2/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo2::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo2::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
