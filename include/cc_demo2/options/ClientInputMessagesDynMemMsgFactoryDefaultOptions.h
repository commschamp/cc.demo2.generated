...
#include "cc_demo2/factory/ClientInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_demo2::factory::ClientInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_demo2::factory::ClientInputMessagesDynMemMsgFactory<TInterface, ClientInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
