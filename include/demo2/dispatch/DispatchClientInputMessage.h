...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref demo2::options::DefaultOptions.
/// @headerfile "demo2/dispatch/DispatchClientInputMessage.h"
...
struct ClientInputMsgDispatcher
{
    ...
    template <typename TMsg, typename THandler>
    static auto dispatch(demo2::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(demo2::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return demo2::dispatch::dispatchClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    /// @return What the @ref dispatchClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(demo2::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(demo2::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return demo2::dispatch::dispatchClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
///     @ref demo2::options::DefaultOptions as template parameter.
/// @note Defined in "demo2/dispatch/DispatchClientInputMessage.h"
using ClientInputMsgDispatcherDefaultOptions =
    ClientInputMsgDispatcher<demo2::options::DefaultOptions>;
