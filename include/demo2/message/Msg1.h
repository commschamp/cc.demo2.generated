...
#include "demo2/message/Msg1Common.h"
...
struct Msg1Fields
{
    ...
    public:
        ...
        {
            return demo2::message::Msg1FieldsCommon::F1Common::hasSpecials();
        }
        
        /// @brief Name of the field.
        static const char* name()
        {
            return demo2::message::Msg1FieldsCommon::F1Common::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo2::message::Msg1FieldsCommon::F2Common::hasSpecials();
        }
        
        /// @brief Name of the field.
        static const char* name()
        {
            return demo2::message::Msg1FieldsCommon::F2Common::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo2::message::Msg1FieldsCommon::F3Common::hasSpecials();
        }
        
        /// @brief Name of the field.
        static const char* name()
        {
            return demo2::message::Msg1FieldsCommon::F3Common::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return demo2::message::Msg1FieldsCommon::F4Common::hasSpecials();
        }
        
        /// @brief Name of the field.
        static const char* name()
        {
            return demo2::message::Msg1FieldsCommon::F4Common::name();
        }
...
public:
    ...
    {
        return demo2::message::Msg1Common::name();
    }
